...
export default function App() {
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center p-4 md:p-0 pt-20 md:pt-0 overflow-y-auto md:overflow-hidden bg-[#0a0a0f] pb-28 md:pb-0">
      {/* Background Image */}
      <Background />
